class QuickSort:
	def main():	
	        ...
	        QuickSort.quick_sort(int_array, 0, len(int_array) - 1)
	...
	def quick_sort(sorting_array: list[int], start: int, end: int):
			...
			pivot = QuickSort.partition(sorting_array, start, end)
			QuickSort.quick_sort(sorting_array, start, pivot - 1)
			QuickSort.quick_sort(sorting_array, pivot + 1, end)		
